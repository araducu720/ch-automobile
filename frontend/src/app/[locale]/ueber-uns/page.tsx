...
export default async function AboutPage() {
  ...
  return (
    <div className="page-transition">
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[var(--bg-secondary)] to-[var(--bg-primary)] py-20 lg:py-28">
        <div className="absolute -top-32 -right-32 h-80 w-80 rounded-full bg-[var(--brand-primary)] opacity-[0.05] blur-3xl" />
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-8">
                <div className="text-center">
                  <div className="text-3xl font-extrabold text-[var(--brand-primary)]">100+</div>
                  <div className="text-sm text-[var(--text-secondary)] mt-1">{th('stats.customers')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-extrabold text-[var(--brand-primary)]">50+</div>
                  <div className="text-sm text-[var(--text-secondary)] mt-1">{th('stats.vehicles')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-extrabold text-[var(--brand-primary)]">15+</div>
                  <div className="text-sm text-[var(--text-secondary)] mt-1">{th('stats.experience')}</div>
                </div>
              </div>
            </div>

            {/* Decorative card */}
            <Card className="bg-gradient-to-br from-[var(--brand-primary)] to-[#1e3a8a] text-white overflow-hidden">
              <CardContent className="p-10 relative">
                ...
                <Trophy className="h-12 w-12 text-[var(--brand-accent)] mb-6" />
      ...
      <section className="py-16 lg:py-24 bg-[var(--bg-secondary)]">
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-[var(--text-primary)]">{t('milestones.title')}</h2>
          ...
          <div className="relative max-w-3xl mx-auto">
            {/* Timeline line */}
            <div className="absolute left-4 lg:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[var(--brand-primary)] via-[var(--brand-accent)] to-[var(--brand-primary)] lg:-translate-x-px" />
            ...
            {timelineYears.map((year, idx) => (
              <div key={year} className={`relative flex items-start gap-6 mb-12 last:mb-0 ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                {/* Dot */}
                <div className="absolute left-4 lg:left-1/2 w-3 h-3 rounded-full bg-[var(--brand-primary)] border-4 border-[var(--bg-secondary)] -translate-x-[5px] lg:-translate-x-[5px] mt-1.5 z-10" />
                ...
                <div className={`ml-10 lg:ml-0 lg:w-[calc(50%-2rem)] ${idx % 2 === 0 ? 'lg:pr-8 lg:text-right' : 'lg:pl-8'}`}>
                  ...
                  <h3 className="text-lg font-semibold text-[var(--text-primary)]">{t(`timeline.${year}.title`)}</h3>
                  <p className="mt-1 text-sm text-[var(--text-secondary)] leading-relaxed">{t(`timeline.${year}.description`)}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 lg:py-24 bg-[var(--bg-primary)]">
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-[var(--text-primary)]">{t('values.title')}</h2>
            <p className="mt-3 text-[var(--text-secondary)]">
              {t('values.subtitle')}
            </p>
          </div>
              ...
              return (
                <Card key={key} className="card-hover text-center">
                  <CardContent className="p-6">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--brand-primary-light)] mx-auto mb-5">
      ...
      <section className="py-16 lg:py-24 bg-[var(--bg-secondary)]">
        <div className="container-main">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-start">
            <div>
              ...
              <div className="mt-8 space-y-5">
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--brand-primary-light)] shrink-0">
                    <MapPin className="h-5 w-5 text-[var(--brand-primary)]" />
                  </div>
                  <div>
                    <p className="font-semibold text-[var(--text-primary)]">{tc('address')}</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--text-primary)]">{tc('phone')}</p>
                    <a
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--text-primary)]">{tc('email')}</p>
                    <a
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--text-primary)]">{tc('openingHours')}</p>
            ...
            {/* Map */}
            <div className="h-[400px] rounded-xl bg-[var(--bg-tertiary)] overflow-hidden shadow-lg">
              <iframe
